...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_HIMETRIC', 'Checked', 'IPicture',
           'OLE_YPOS_CONTAINER', 'Default', 'FONTBOLD', 'FontEvents',
           'OLE_YSIZE_CONTAINER', 'IFontEventsDisp',
           'OLE_XSIZE_HIMETRIC', 'FONTNAME', 'Unchecked',
           'FONTSTRIKETHROUGH', 'OLE_COLOR', 'Font', 'IFont',
           'OLE_XPOS_CONTAINER', 'IPictureDisp',
           'LoadPictureConstants', 'OLE_OPTEXCLUSIVE',
           'OLE_YSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'Color',
           'FONTUNDERSCORE', 'OLE_YSIZE_PIXELS', 'OLE_YPOS_PIXELS',
           'OLE_XPOS_PIXELS', 'OLE_CANCELBOOL', 'IFontDisp',
           'VgaColor', 'OLE_XPOS_HIMETRIC', 'Gray', 'FONTSIZE',
           'FONTITALIC', 'OLE_XSIZE_PIXELS', 'Monochrome',
           'OLE_HANDLE', 'StdFont', 'OLE_TRISTATE', 'StdPicture',
           'Picture', 'OLE_XSIZE_CONTAINER']
